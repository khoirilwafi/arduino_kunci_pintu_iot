...
void setup(void)
{
    ...
    else if(EEPROM.read(0) == 'U')
    {
        while(1)
        {
            digitalWrite(wifi_status, !digitalRead(wifi_status));
            digitalWrite(data_status, !digitalRead(data_status));
...
void loop(void)
{
    ...
    // semua proses yang membutuhkan koenksi wifi
    ...
    {
        alert_message = "Pintu terbuka tanpa autentikasi yang sah, mungkin ada penerobosan. Menunggu pintu ditutup ...";
    ...
    // cek jika kunci pintu terbuka lebih dari 30 detik
