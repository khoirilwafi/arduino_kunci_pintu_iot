...
//    {
//        bt_message = SerialBT.readStringUntil('\n');
//        bt_message.trim();
//
//        // cek format pesan
//        if(bt_message.startsWith("{") && bt_message.endsWith("}"))
//        { 
//            bt_package = JSON.parse(bt_message);
//
//            // cek event
...
//
//                    SerialBT.println("{\"status\":\"success\"}");
//
...
//                    {
//                        SerialBT.println("{\"status\":\"wifi_not_connected\"}");
//                    }
//                    else
//                    {
...
////                            else
////                            {
////                                SerialBT.println(register_response);
////                                system_log("DOOR", "register gagal");
////                            }
//
//                            SerialBT.println(register_response);
//                            system_log("DOOR", "register sukses");
//                        }
//                        else
//                        {
//                            SerialBT.println("{\"status\":\"request_error\"}");
...
//}
//
//void bt_door_command(String message)
//{
//    if(bt_message.startsWith("{") && bt_message.endsWith("}"))
//    {
//        JSONVar bt_command = JSON.parse(message);
//
...
//            {
//                SerialBT.println("{\"status\":\"door_aleady_open\"}");
//            }
